...
# TODO include defensive yards allowed
```

```{r calculate_projections}
# projections <- 
#   projections_table(data_result = scraped_data, scoring_rules = scoring_table) %>% 
#   add_ecr() %>% 
#   add_risk() %>% 
#   add_adp() %>% 
#   add_aav() %>% 
...
6. age - player age
7. exp - ?
8. avg_type - robust, average, weighted
9. points
10. pos_rank - position rank by avg_type
11. drop_off - ?
12. sd_pts - ?
13. floor - least projected points
14. ceiling - most projected points
